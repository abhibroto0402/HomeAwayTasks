...
import com.homeaway.testcases.APIValidationFuelStation;
 ...
 */
@RunWith(Suite.class)
@SuiteClasses({ SubmitOrderValidations.class, CartValidation.class, MyAccountValidations.class, APIValidationFuelStation.class })
